...
<head>
    ...
    <title>SALE FORCE AUTOMATION</title>
...
<body>
    <div class="nav">
        <div class="flex flex-justify">
            <div class="logo">
                <h2><a class="roboto font22" href="${pageContext.request.contextPath}" title="HOME">SALE FORCE </a></h2>
                <a class="roboto font20" href="${pageContext.request.contextPath}" title="HOME">AUTOMATION</a>
            </div>
            <div class="navbar">
                <ul id="menu" class="flex flex-justify">
                    <li class="noto weight700 font20" style="margin: 0 30px;" data-menuanchor="회사소개">
                        <a href="${pageContext.request.contextPath}/#회사소개">회사소개</a>
                    </li>
                </ul>
            </div>
            <div class="login">
                <h2><a class="noto weight700 font18 f6" href="${pageContext.request.contextPath}/SFA_login" title="HOME">그룹웨어 로그인</a></h2>
            </div>
        </div>
    </div>
    <div id="fullpage">
                ...
                <div class="main-right">
                    <div class="">
                        ...
                        <span class="main-bottom">
                            <img class="img" src="${pageContext.request.contextPath}/images/main/main_sales.png" />
                        </span>
                    </div>
                </div>
            </div>
                ...
                <div class="main">
                    ...
                    <div class="flex" style="justify-content: space-around;">
                        <div class="list noto" style="font-size: 18px;">
                            <div class="noto left p-lr5">
                                <p class="weight500 font18"><i class="fas fa-box p-lr5"></i>품목/재고관리</p>
                                <p>그룹 별 품목 관리</p>
                                <p>품목 출고 단가 관리</p>
                                <p>품목/재고 규격 관리</p>
                                <p>입고/출고별 재고 수량 관리</p>
                        ...
                        <div class="list noto" style="font-size: 18px;">
                            <div class="noto left p-lr5">
                                <p class="weight500"><i class="fas fa-gifts p-lr5"></i>수주/판매관리</p>
                                <p>거래처별 품목관리</p>
                                <p>수주/판매별 단가/공급가액/부가세 관리</p>
                                <p>수주/판매별 해당 프로젝트 목록 관리</p>
                            </div>
                        </div>
                        <div class="list noto" style="font-size: 18px;">
                            <div class="noto left p-lr5">
                                <p class="weight500 font18"><i class="fas fa-user-tie p-lr5"></i>고객관리</p>
                                <p>거래처 등급별 관리(S급, A급, B급, C급)</p>
                                <p>거래처 종목별 관리</p>
                                <p>고객별 매출 수</p>
                                <p>입고/출고별 재고 수량 관리</p>
                            </div>
                        ...
                        <div class="list noto" style="font-size: 18px;">
                            <div class="noto left p-lr5" style="margin-bottom: 15px;">
                                <p class="weight500"><i class="fas fa-address-book p-lr5"></i>직원관리</p>
                                <p>주간보고, 회의록 확인</p>
                                <p>직원별 일일스케줄 확인</p>
                            </div>
                        </div>
                    ...
                    <div class="btn-wrap noto">
                       <a class="btn" href="${pageContext.request.contextPath}/SFA_register">체험하기</a>
                    </div>
                </div>
            </div>
...
<script>
    $('#fullpage').fullpage({
        ...
        menu: '#menu',
        anchors: ["SFA", '회사소개', '제품소개'],
        scrollingSpeed: 600,

        afterLoad: function (origin, destination) {
            if (destination.anchor != "SFA") {
                $(".nav a").css('color', '#000');
            } else {
                $(".nav a").css('color', '#fff');
            }
