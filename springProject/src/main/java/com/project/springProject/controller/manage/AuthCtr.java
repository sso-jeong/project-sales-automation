package com.project.springProject.controller.manage;
...
public class AuthCtr {
	...
	@RequestMapping("SFA_authTop")
	@ResponseBody
	public EmpVO getAuthListTop() {
		return mSrv.getAuthListTop();
	}
	
	@RequestMapping("SFA_authOne")
	@ResponseBody
	...
	@RequestMapping(value="/authDel", method = RequestMethod.POST)
	@ResponseBody
